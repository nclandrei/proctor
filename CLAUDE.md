...
This repository builds `proctor`, a Go CLI that enforces manual verification contracts for agent-built web, iOS, and CLI features.
...
- Preserve clean extension points for additional surfaces.
